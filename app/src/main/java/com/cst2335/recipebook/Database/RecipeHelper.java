package com.cst2335.recipebook.Database;
...
public class RecipeHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "RecipeAPP";
    public static  int VERSION_NUM = 1;
    public static final String RESULTS_TABLE = "recipeTable";
    public static final String FAVORITE_TABLE = "favTable";
    public static final String PK_ID = "id";
    public static final String COL_TITLE = "recipe_title";
    public static final String COL_DETAIL = "publisher_info";
    public static final String COL_RECIPE_ID = "source_url";
    ...
    public static long insertItem(String tableName, String title, String publisher, String contentUrl, String image) {
        ...
        content.put(COL_DETAIL, publisher);
        content.put(COL_RECIPE_ID, contentUrl);
